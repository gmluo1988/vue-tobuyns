<template>
    <div class="pagecontent">
        ...
        <div class="pagecontent-body">
            ...
            <!--列表-->
            <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" :row-class-name="tableRowClassName"
                style="width: 100%;">
                ...
                <el-table-column prop="birthday" label="生日" :formatter="formatDate" sortable>
                </el-table-column>
            ...
            <el-col :span="24" class="toolbar">
                ...
                <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="page" :page-sizes="[5, 10, 15 ,20, 30]"
                    :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total" style="float:right;">
                </el-pagination>
            </el-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //用户列表中生日的时间戳显示转换（格式为：yyyy-MM-dd）
